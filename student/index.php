...
<body class="homepage_parallax" data-spy="scroll" data-target=".navbar-fixed-top" data-offset="100">
                        ...
                        <div class="navbar-header">
                            ...
                            <div class="logo-container">
                                <div class="logo-wrap local-scroll">
                                    <a href="#home">
                                        <img class="logo" src="../img/logo_black.png" alt="logo" data-rjs="2">
                                    </a>
                                </div>
                            </div>
    ...
    <footer class="site-footer">
        <div class="container">
            <small class="copyright pull-left">Copyrights © 2021 All Rights Reserved By <a href="" target="_blank">Tharun</a>.</small>
...
<script src="https://mediafiles.botpress.cloud/526bee95-397b-439c-aeb7-51073225c483/webchat/v2/config.js"></script>
