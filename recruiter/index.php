...
<head>
    ...
    <title><?php echo $recruiter["name"] ?></title>
...
<body class="homepage_parallax" data-spy="scroll" data-target=".navbar-fixed-top" data-offset="100">
                        ...
                        <div class="col-md-8 col-xs-12 nav-wrap">
                            <div class="collapse navbar-collapse" id="navbar-collapse">
                                ...
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li><a data-scroll href="#contact">Job Posts</a></li>
                                    <li><a href="./add-vacancy.php">Add Vacancy</a></li>
                                    <li><a href=".\edit-recruiter.php">Settings</a></li>
    ...
    <!-- Start Intro -->
    <section class="parallax-bg" style="background-image:url(../img/slider/s1.jpg)" data-stellar-background-ratio="0.5">
        <!-- Section Title -->
        <div class="js-height-full container">
            <div class="intro-content  text-center vertical-section">
                <div class="vertical-content ">
                    <h4 class="wow fadeInDown  " data-wow-duration="1s" data-wow-delay="0.8s">Welcome Back</h4>
                    <h1 class="wow zoomIn m-bottom-20" data-wow-duration="1s" data-wow-delay="0.6s"><?php echo $recruiter["name"] ?></h1>
                </div>
            </div>
            <!-- Scroll Down -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 m-bottom-30">
                    <img src="..<?php echo $recruiter["profilephoto"] ?>" style="object-fit: contain; border-radius: 10px; aspect-ratio: 4/3;" alt="About Image" class="img-responsive wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.6s" />
                </div> <!-- /.col -->
                ...
                <div class="col-md-6">
                    ...
                    <div class="wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.6s">
                        <p><?php echo $recruiter["description"] ?></p>
                    </div>
                    <a data-scroll href="#contact" class="m-top-30 btn btn-main btn-theme wow fadeInUp" data-wow-delay="0.7s">Job Posts</a>
                </div> <!-- /.col -->
    ...
    <section id="contact" class="dark-bg p-top-80 p-bottom-80">
        <div class="container ">
            <div class="section-title text-center m-bottom-30">
                ...
                <p class="section-subtitle wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.6s"><em>View Job roles of <?php echo $recruiter["name"] ?></em></p>
            </div>
            <div style="background: white; height: 75vh; border-radius: 10px;">
                <iframe src="./job-post.php?id=<?php echo $recruiter['id']?>" frameborder="0" style="width: 100%; height: 100%; border-radius: 10px;"></iframe>
            </div>
            <div style="text-align:center;">
                <a href="./add-vacancy.php" class="m-top-30  btn btn-main btn-theme wow fadeInUp animated" data-wow-delay="0.7s" style="visibility: visible; animation-delay: 0.7s; animation-name: fadeInUp;  padding:15px; border-radius: 10px; margin-right: 5px;">Add Vacancy</a>
            </div>
        </div>
    </section>
    ...
    <footer class="site-footer">
        <div class="container">
            <small class="copyright pull-left">Copyrights © 2021 All Rights Reserved By <a href="/">HIRERIGHT</a>.</small>
        </div>
        <!-- /container -->
    </footer>
    <!-- End Footer -->
